...
create TABLE PLAYERREGISTRATION(
    ...
    ,PRIMARY KEY (playerid,Clubname,Seasonname,Seasonyear,En_Agegroup,En_Teamnumber)
    ,FOREIGN KEY (En_Agegroup,En_Teamnumber,Seasonname,Seasonyear,Clubname) REFERENCES TEAMENTRY
